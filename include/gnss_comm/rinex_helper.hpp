 ...
 *---------------------------------------------------------- args   : std::string rinex_filepath I
 *RINEX file path std::map<uint32_t, std::vecot<EphemBase>>&   sat2ephem             IO  satellite
 *number to ephemeris return : None
 *---------------------------------------------------------------------------------------------*/
 ...
 *          std::vector<std::vector<ObsPtr>>&    rinex_meas            IO  GNSS measurement in time
 *order return : None
 *---------------------------------------------------------------------------------------------*/
 ...
 * args   : std::string                          rinex_filepath        I   RINEX file path
 *          std::vector<std::vector<ObsPtr>>&    rinex_meas            I   GNSS measurement in time
 *order return : None This function is still under experiment, many hacks here.
 *---------------------------------------------------------------------------------------------*/
 ...
 * args   : std::string                      rinex_filepath        I   RINEX file path
 *          std::vector<double>              iono_params           IO  8 ionosphere parameters
